...
<jsp:useBean id="sampleCalculateProxyid" scope="session" class="com.simplilearn.workshop.CalculateProxy" />
<%
...
case 10:
        gotMethod = true;
        com.simplilearn.workshop.Calculate getCalculate10mtemp = sampleCalculateProxyid.getCalculate();
...
case 13:
        ...
        int multply13mtemp = sampleCalculateProxyid.multply(a_1idTemp,b_2idTemp);
        String tempResultreturnp14 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(multply13mtemp));
        %>
        <%= tempResultreturnp14 %>
        <%
break;
